        ...
        >
            <div className={`${bgColor === 'light' ? 'bg-light': 'bg-charcoal'} flex flex-col justify-center items-center rounded-md w-100 p-12 lg:pt-24 lg:pb-32`}>
                ...
                <div className="mt-5 md:flex md:flex-wrap md:justify-center md:mt-4 lg:mt-9 md:gap-5 w-full">
                    {block.fields.content.blocks[0].content_type.handle === 'horizontal_block' && block.fields.content.blocks.map((item: BlockData) => {
                        return (
                    ...
                    {block.fields.content.blocks[0].content_type.handle === 'stacked_block' && block.fields.content.blocks.map((item: BlockData) => {
                        return (
