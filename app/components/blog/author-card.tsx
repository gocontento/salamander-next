    ...
    return (
        <div className="flex flex-col md:flex-row gap-7 bg-charcoal text-white pl-8 pr-8 py-9 items-center">
            ...
            <div className="flex flex-col max-w-[400px]">
                <h3 className="text-md font-bold mt-0">{author.name}</h3>
