...
export default function Footer() {
  return (
    <footer className="bg-charcoal">
      <div className="hidden md:flex md:flex-col md:items-center md:px-7 md:py-12 lg:flex-row lg:justify-between  lg:px-24 lg:py-20">
        <div className="mb-5 flex flex-col justify-center text-center text-white md:basis-1/3 lg:items-start">
          <Link
            href="/#features"
            className="block px-2 py-4 text-sm text-white transition duration-300 hover:text-pink"
          >
            Features
          </Link>
          <Link
        ...
        <div className="order-last mt-5 flex flex-col items-center justify-center md:mt-0">
          <Link href="/" className="mx-auto mb-12 mt-5">
            <svg
              width="49"
              height="57"
              viewBox="0 0 49 57"
      ...
      <div className="flex flex-col justify-center px-9 py-10 md:hidden">
        <Link href="/" className="mx-auto mb-12 mt-5">
          <svg
            width="49"
            height="57"
        ...
        <div className="flex justify-between">
          <div className="flex flex-col items-start justify-center">
            <Link
              href="/#features"
              className="block py-2 text-xs text-white transition duration-300 hover:text-pink"
            >
              Features
            </Link>
            <Link
        ...
        <h3 className="mt-10 flex items-center justify-between gap-5 text-xs font-semibold uppercase tracking-wider text-white text-opacity-40">
          Powered by
          <Link href="https://www.contento.io">
            <img
              className="w-[150px] pb-2 hover:opacity-60"
              src="/Contento-Logo.png"
            />
          </Link>
        </h3>
